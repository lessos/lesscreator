...
l9rTab.TabletTitleImage = function(urid, imgsrc)
{
    ...
    if (!imgsrc && item.icon) {
        ...
        if (item.icon.slice(0, 1) == "/") {
            ...
            imgsrc = l9r.base + "~/creator/img/"+ item.icon +".png";
        }
    }
...
l9rTab.TabletTitle = function(urid, loading)
{
    ...
    if ($("#pgtab"+ urid).length < 1) {
        ...
        if (item.icon) {
            ...
            if (loading) {
                var imgsrc = l9r.base + "~/creator/img/loading4.gif";
            } else {
                var imgsrc = l9r.base + "~/creator/img/"+ item.icon +".png";
            }
...
l9rTab.TabletMore = function(tg)
{
    ...
    for (i in l9rTab.pool) {
        ...
        ol += '<div class="ltm-ico"><img src="'+ l9r.base + '~/creator/img/'+ l9rTab.pool[i].icon +'.png" align="absmiddle" /></div>';
