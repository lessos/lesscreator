...
<table>
    <tr>
        <td width="100px"><img class="rtlogo" src="/lesscreator/~/creator/img/rt/nginx_200.png" /></td>
        <td >
            <div class="title">Nginx</div>
            <div class="desc">High Performance Web Server</div>
        </td>
        <td align="right">
            <img class="rtset" src="/lesscreator/~/creator/img/for-test/setting2-128.png" />
        </td>
    </tr>
</table>
</a>
...
<table>
    <tr class="line">
        <td width="100px"><img class="rtlogo" src="/lesscreator/~/creator/img/rt/php_200.png" /></td>
        <td >
...
<table>
    <tr class="line">
        <td width="100px"><img class="rtlogo" src="/lesscreator/~/creator/img/rt/go_200.png" /></td>
        <td >
...
<table>
    <tr class="line">
        <td width="100px"><img class="rtlogo" src="/lesscreator/~/creator/img/rt/nodejs_200.png" /></td>
        <td >
...
<table>
    <tr class="line">
        <td width="100px"><img class="rtlogo imggray" src="/lesscreator/~/creator/img/rt/java_200.png" /></td>
        <td >
            <div class="title">Java <span class="indev">(Upcoming, later supported)</span></div>
            <div class="desc">Java Runtime Environment</div>
        </td>
        <td align="right">
            <img class="rtset imggray" src="/lesscreator/~/creator/img/for-test/setting2-128.png" />
        </td>
    </tr>
</table>
</a>
...
<table>
    <tr class="line">
        <td width="100px"><img class="rtlogo imggray" src="/lesscreator/~/creator/img/rt/python_200.png" /></td>
        <td >
