...
foreach (glob($glob) as $f) {
    ...
    $li .= "<img src='/hcreator/static/img/{$fmi}.png' align='absmiddle' title='{$fm}' /> ";
    ...
    if (strlen($path) != 0 || $fn != 'hootoapp.yaml') {
        ...
        $lip .= "<div class='rcitem'>
            <div class='rcico'><img src='/hcreator/static/img/page_white_copy.png' align='absmiddle' /></div>
        ...
        $lip .= "<div class='rcitem'>
            <div class='rcico'><img src='/hcreator/static/img/delete.png' align='absmiddle' /></div>
