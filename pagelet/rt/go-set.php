...
<td width="180px" valign="top">
    <img src="/lesscreator/static/img/rt/go_200.png" width="160" height="80" />
</td>
<td>  
    <h4>Go runtime environment</h4>
    <br />
    <div id="k3bahm" class="alert alert-info">
        <?php echo $this->T('rt-go-desc')?>
        <br/><?php echo $this->T('rt-go-desc2')?>
    </div>
    <ul>
        <li>Version: 1.1.2</li>
        <li>GOPATH=~/runtime/gopath</li>
    </ul>
    <label class="checkbox">
      <input id="hldp2x" type="checkbox" value="1" <?php echo $enabled_check?> /> <?php echo $this->T('Enable')?> Go
    </label>
</td>
</tr>
</table>
...
lessModalButtonAdd("mhm701", "<?php echo $this->T('Save')?>", "_proj_rt_go_save()", "btn-inverse");
