...
$(document).click(function(event) {
    ...
    if (l4iStorage.Get(uname +"LastProjPath") != sessionStorage.ProjPath) {
        l4iStorage.Set(uname +"LastProjPath") = sessionStorage.ProjPath;
    }
});
...
$.ajax({
    url     : "/lesscreator/api/proj/start?proj="+ l4iSession.Get("ProjPath"),
    type    : "GET",
    timeout : 10000,
    success : function(rsp) {
