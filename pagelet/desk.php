...
<table id="hdev_header" width="100%" border="0">
  <tr>
    ...
    <td align="right" style="min-width:550px;max-wid:600px;">
        ...
        <div class="input-prepend input-append">
            <button class="btn btn-danger btn-small " type="button">TODO <?php echo $this->T('plugins-desc')?></button>
            <button class="btn btn-danger btn-small " type="button"><i class="icon-comment icon-white"></i> <?php echo $this->T('Chat')?></button>
            <button class="btn btn-danger btn-small " type="button"><i class="icon-list icon-white"></i> <?php echo $this->T('Task Manage')?> ...</button>
        </div>
